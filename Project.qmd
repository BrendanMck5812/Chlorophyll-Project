---
title: "Chlorophyll Analysis: Manatee County Intern project"
format: html
editor: visual
---
...
ggplot(penguins, 
  ...
  scale_color_manual(values = c("darkorange","purple","blue")) +
  labs(
